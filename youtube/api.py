...
def search_videos(query, max_results=50, start_date=None, end_date=None) -> dict:
...
def get_comments(video_id, max_results=50) -> dict:
    return execute_comment_query(CommentThreadRetrieveQuery(video_id=video_id, max_results=max_results))
